package com.example.androidsubmissionintermediate.customView
    ...
    private fun init() {
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                if ((s.length) < 8) {
                    setError("Password minimal 8 karakter",errorImage )
                    setCompoundDrawablesWithIntrinsicBounds(null, null, errorImage, null)
                } else {
